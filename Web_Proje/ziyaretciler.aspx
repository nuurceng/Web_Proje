<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ziyaretciler.aspx.cs" Inherits="Web_Proje.ziyaretciler" %>
            ...
            <asp:DataList ID="DataList1" runat="server">
                <ItemTemplate>
                    <table class="auto-style1" style="text-align:center">
                        <tr>
                            <td style="width: 50px">
                                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="10pt" Text='<%# Eval("id") %>'></asp:Label>
                            </td>
                            <td style="width: 100px">
                                <asp:Label ID="Label2" runat="server" Font-Size="10pt" Text='<%# Eval("adres") %>'></asp:Label>
                            </td>
                            <td style="width: 50px">
                                <asp:Label ID="Label3" runat="server" Font-Size="10pt" Text='<%# Eval("ip") %>'></asp:Label>
                            </td>
                            <td style="width: 200px">
                                <asp:Label ID="Label4" runat="server" Font-Size="8pt" Text='<%# Eval("kaynak") %>'></asp:Label>
                            </td>
                            <td style="width: 200px">
                                <asp:Label ID="Label5" runat="server" Font-Size="8pt" Text='<%# Eval("zaman") %>'></asp:Label>
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
