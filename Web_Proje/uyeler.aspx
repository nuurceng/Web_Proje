<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uyeler.aspx.cs" Inherits="Web_Proje.uyeler" %>
                    ...
                    <table class="auto-style1">
                        <tr>
                            <td style="width: 200px">
                                <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="16pt" Text='<%# Eval("adivesoyadi") %>'></asp:Label>
                            </td>
                            <td style="width: 200px">
                                <asp:Label ID="Label2" runat="server" Font-Size="12pt" Text='<%# Eval("uyeemail") %>'></asp:Label>
                            </td>
                            <td style="width: 200px">
                                <asp:Label ID="Label3" runat="server" Font-Size="12pt" Text='<%# Eval("kullaniciadi") %>'></asp:Label>
                            </td>
                             <td style="width: 200px">
                                <asp:Label ID="Label6" runat="server" Font-Size="12pt" Text='<%# Eval("uyeyas") %>'></asp:Label>
                            </td>
                            <td style="width: 100px; text-align: right;">
                           <a href="uyeler.aspx?uyeid=<%#Eval("uyeid")%>&islem=sil"><img alt="" class="auto-style2" src="tema/sil.jpg" /></a>     
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     
                            </td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <asp:Label ID="Label4" runat="server" Text='<%# Eval("uyesifre") %>'></asp:Label>
                            </td>
