<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uyeyeozel.aspx.cs" Inherits="Web_Proje.uyeyeozel1" ValidateRequest="false" %>
     ...
     <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div style="height: 33px; background-color:#dbb2ed; width: 900px;">&nbsp;&nbsp;<asp:Button ID="btnarti" runat="server" Height="28px" Text="+" Width="30px" OnClick="btnarti_Click1" />
&nbsp;&nbsp;
            <asp:Button ID="btneksi" runat="server" Height="30px"  Text="-" Width="30px" OnClick="btneksi_Click1"/>
            &nbsp;&nbsp; Üyeye Özel Ekleme Paneli</div>
        <asp:Panel ID="Panel1" runat="server" BackColor="#D5C6CB" Width="900px">
            <table class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style13">
                        <asp:Button ID="btnekle" runat="server"  Font-Bold="False" Height="34px" Text="Ekle" Width="68px" OnClick="btnekle_Click1"/>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style2" style="text-align: right">&nbsp;</td>
         ...
         <div style="height: 33px; background-color:#dbb2ed; width: 900px;">&nbsp;&nbsp;<asp:Button ID="btnddarti" runat="server" Height="28px" Text="+" Width="30px" OnClick="btnddarti_Click1"  />
&nbsp;&nbsp;
            <asp:Button ID="btnddeksi" runat="server" Height="30px" Text="-" Width="30px" OnClick="btnddeksi_Click1" />
            &nbsp;&nbsp; Üyeye Özel Düzenleme Paneli</div>
                    ...
                    <table class="auto-style1">
                        <tr>
                            <td class="auto-style7" style="width: 500px">
                                <asp:Literal ID="Literal1" runat="server" Text='<%# Eval("uobaslik") %>'></asp:Literal>
                            </td>
                            <td class="auto-style8">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; <a href='uyeyeozelguncelle.aspx?uoid=<%# Eval("uoid") %>'>
                                &nbsp;</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='uyeyeozelguncelle.aspx?uoid=<%# Eval("uoid") %>'><img alt="" class="auto-style15" src="tema/düzenle.jpg" /></a>&nbsp; 
                            </td>
                            <td style="width: auto">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='uyeyeozel.aspx?uoid=<%# Eval("uoid") %>&islem=sil'>
                                <img alt="" class="auto-style16" src="tema/sil.jpg" />
                                </a> 
                            </td>
                        </tr>
                    </table>
